...
const Index = () => {
  ...
  <div className="site-wrap">
    ...
    {/* NAVBAR */}
   <Header title="job board" signedIn={true}></Header>
    {/* HOME */}
      ...
      <div className="container">
        <div className="row mb-5 justify-content-center">
          <div className="col-md-7 text-center">
            ...
            <p className="lead text-white"> SkillHunt are like windows into the job market, where the statistics tell the story of opportunities, talent, and the ever-evolving landscape of employment.</p>
          </div>
        </div>
