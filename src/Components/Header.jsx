              ...
              <ul className="site-menu js-clone-nav d-none d-xl-block ml-0 pl-0">
                ...
                {signedIn && userType === '0' && (
                  <>
                    ...
                    <li>
                      <NavLink className={(navData) => navData.isActive ? 'active' : ''} to='/Practice'>Practice for interview ?</NavLink>
                    </li>
          ...
          <div className="container">
            <div className="row">
              <div className="col-md-7">
                ...
                {props.rate && (
                  <>
                    <span className="text-white font-weight-bold">Total Rate:</span>
                    <ProgressBar completed={props.rate} />
                  </>
                )}
              </div>
            </div>
